// Package libtunnel is a thin, stable façade over stable/alpha versioned packages.
//
// The package is split into three pieces:
//
//   - libtunnel (this package) — thin façade exposing New. Stable surface for
//     application code.
//   - github.com/cnuss/libtunnel/v1 — the stable Builder[T] interface and Result
//     type. Application code that wants to declare types against the interface
//     imports this.
//   - github.com/cnuss/libtunnel/v1alpha1 — the current implementation. Internals
...
//
//	res := libtunnel.New[string]().WithName("greeting").WithValue("hello").Build()
